...
const aboutImages = import.meta.glob('/public/assets/images/HOME PAGE/about_us/*.{webp,jpg,jpeg,png}', { eager: true, query: '?url', import: 'default' }) as Record<string, string>;
