...
const featuredImages = import.meta.glob('/assets/images/exterior/featured-works/*.{webp,jpg,jpeg,png}', { eager: true, query: '?url', import: 'default' }) as Record<string, string>;
const galleryImages = Object.values(featuredImages);

// Import all lighting scenario images
const lightingImages = import.meta.glob('/assets/images/exterior/lighting/*.{webp,jpg,jpeg,png}', { eager: true, query: '?url', import: 'default' }) as Record<string, string>;
...
const landscapeImages = import.meta.glob('/assets/images/exterior/landsacpe/*.{png,jpg,jpeg,webp}', { eager: true, query: '?url', import: 'default' }) as Record<string, string>;
...
const animationVideos = import.meta.glob('/assets/images/exterior/animation/*.mp4', { eager: true, query: '?url', import: 'default' }) as Record<string, string>;
const animationGallery = Object.values(animationVideos);

// Import carousel images for Still Renderings
const carouselImages = import.meta.glob('/assets/images/exterior/carousel/*.{webp,jpg,jpeg,png}', { eager: true, query: '?url', import: 'default' }) as Record<string, string>;
