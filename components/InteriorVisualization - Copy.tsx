...
const InteriorVisualization: React.FC<{ onNavigate: (page: Page) => void }> = ({ onNavigate }) => {
    ...
    const specializedAnimationsData = [
        {
            ...
            icon: Layers,
            features: ["4K resolution standard", "Phase labels and annotations", "Timeline integration", "Technical accuracy"],
            imgSrc: 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=1200&q=80',
            imgAlt: 'Phasing Animation',
            label: 'View Phasing'
        },
        {
            title: "Social Media Content",
            ...
            icon: Smartphone,
            features: ["9:16 Vertical (1080x1920)", "15-60 second clips", "Trending audio integration", "Caption overlays"],
            imgSrc: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=1200&q=80',
            imgAlt: 'Social Media Content',
            label: 'View Social'
        },
        {
            title: "Timelapse Video",
            ...
            icon: Clock,
            features: ["4K resolution output", "30fps smooth playback", "Weather-resistant capture", "Cloud storage backup"],
            imgSrc: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1200&q=80',
            imgAlt: 'Timelapse Video',
            label: 'View Timelapse'
        }
    ];

    // ── Data: 3D Floor Plan & Virtual Tour (Sticky Scroll) ────────────
    const immersiveItems = [
        ...
        },
        {
            ...
            description: 'Interactive experiences that allow viewers to navigate spaces freely. Detailed panoramic views compatible with web, mobile, and VR headsets.',
            imgSrc: 'https://archicgi.com/wp-content/uploads/2025/03/living-room-interior-3d-rendering-MU5SFJXV-4000x2250.jpg',
            imgAlt: '3D Virtual Tours',
            label: 'Explore 360° Tour',
            features: ['360° panoramic views', 'VR headset compatible', 'Web & mobile ready', 'Interactive hotspots']
        },
        {
            title: 'Dollhouse Views',
            description: 'Unique cutaway perspectives showing the entire structure in miniature. Ideal for understanding spatial relationships and overall design intent.',
            imgSrc: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200&q=80',
            imgAlt: 'Dollhouse Views',
            label: 'View Dollhouse',
            features: ['Cutaway roof sections', 'Interior visibility', "Context surroundings", 'Marketing ready']
        }
    ];
    ...
    return (
        <div className="bg-neutral-950 min-h-screen pt-20">
            ...
            <section ref={heroRef} className="relative py-24 lg:py-32 px-6 lg:px-12 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    ...
                    <p className={`text-neutral-400 text-lg md:text-xl max-w-2xl leading-relaxed transition-all duration-1000 delay-200 ${heroVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                        Bring your architectural vision to life with cinematic animations, interactive tours, and specialized content that moves people.
                    </p>
                </div>
            ...
            <section className="py-20 px-6 lg:px-12 bg-neutral-900 border-y border-white/5">
                <div className="max-w-7xl mx-auto">
                    <div className="relative aspect-video rounded-3xl overflow-hidden group cursor-pointer">
                        <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200&q=80" alt="Animation Showreel" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                        <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-colors flex flex-col items-center justify-center">
                            <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                <Play fill="black" className="w-8 h-8 text-black translate-x-1" />
                            </div>
                            <span className="text-lg font-medium tracking-widest uppercase">Play Showreel 2024</span>
                        </div>
                    </div>
                </div>
            </section>
                                ...
                                <div className="aspect-video w-full overflow-hidden rounded-2xl bg-neutral-800 relative flex items-center justify-center">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <div className="flex flex-col items-center gap-4">
                                            <item.icon className="w-14 h-14 text-white group-hover:scale-110 transition-transform duration-300" />
            ...
            {/* ════════════════════════════════════════════════════════
                3D FLOOR PLAN & VIRTUAL TOUR (STICKY SCROLL)
            ════════════════════════════════════════════════════════ */}
            <section className="bg-neutral-900/50">
                {/* Section header — scrolls away normally */}
                <div className="px-6 lg:px-12 pt-24 pb-16 max-w-7xl mx-auto">
                    ...
                    <h2 className="font-display text-4xl md:text-6xl mb-6 leading-tight">
                        3D Floor Plan & <span className="text-stroke">Virtual Tour</span>
                    </h2>
                    <p className="text-neutral-500 max-w-xl">
