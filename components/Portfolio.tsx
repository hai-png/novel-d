...
const featuredImages = import.meta.glob('/public/assets/images/HOME PAGE/featured_works/*.{webp,jpg,jpeg,png}', { eager: true, import: 'default' }) as Record<string, string>;
const featuredGallery = Object.values(featuredImages);

// Import all interior images as fallback
const interiorImages = import.meta.glob('/public/assets/images/interior/**/*.webp', { eager: true, import: 'default' }) as Record<string, string>;
const interiorGallery = Object.values(interiorImages);

// Import all exterior images as fallback
const exteriorImages = import.meta.glob('/public/assets/images/exterior/**/*.webp', { eager: true, import: 'default' }) as Record<string, string>;
